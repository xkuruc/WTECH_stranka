        ...
        <section class="osobne_udaje_section">
            <form>
                ...
                <div class="osobne_udaje_container">
                    ...
                    <select class="registration_input">
                        <option value="" disabled selected>Pohlavie*</option>
                        <option value="male">Chlop</option>
                        <option value="female">Princesska</option>
                    </select>

                    <input class="registration_input" type="password" name="password" placeholder="Potvrdiť heslo*" required/>

                    <div class="date-input">
                        <span class="label">Dátum narodenia</span>
                        <input class="daco" type="date">
                    </div>
                    <div class="newsletter_reg">
                        <label>
                            <input class="registration_input" type="checkbox" name="newsletter">
                ...
                <div class="kontaktne_udaje_container">
                    ...
                    <input class="registration_input div2" type="text" name="adresa" placeholder="Ulica*" required/>
                ...
                <div class="personalizacia_container">
                    ...
                    <select id="height" class="registration_input personalizacia_div3">
                        <option value="" disabled selected>Tvoja výška</option>
                    </select>

                    <select id="weight" class="registration_input personalizacia_div4">
                        <option value="" disabled selected>Tvoja hmotnosť</option>
                    </select>

                    <select id="shoesize" class="registration_input personalizacia_div5">
                        <option value="" disabled selected>Veľkosť topánok vo US</option>
                    </select>
