...
<head>
    ...
    <link rel="stylesheet" href="./css/text_divider.css">
    <link rel="stylesheet" href="./css/popup_overlay.css">
    <link rel="stylesheet" href="./css/profil.css">
    <link rel="stylesheet" href="./css/profile_intro.css">
    <link rel="stylesheet" href="./css/objednavka_prehlad.css">
...
<body>
    ...
    <main>
            ...
            <div class="popup_container">
                <div class="popup_content">
                    ...
                    <div class="popup_buttons">
                        <button id="popup_accept">Áno</button>
                        <button id="popup_cancel">Nie</button>
        ...
        <script src="./javascript/popup_okno.js"></script>
    </main>
